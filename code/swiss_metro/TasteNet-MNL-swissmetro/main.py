...
if __name__ == '__main__':
    ...
    # save summary
    f = open(args.result_path + "/" + "summary_result.txt", "w")
    f.write(str(x))
    f.close()

    # save model args 
    f = open(args.result_path + "/" + "summary_args.txt", "w")
    f.write(str(args))  
    f.close()

    # save model string
    f = open(args.result_path + "/" + "summary_modelstr.txt", "w")
    f.write(str(model))  
    f.close()
    ...
    pickle.dump(b_test, open(args.result_path + "/" + "b_test.pkl", "wb"))
    ...
    b_mean_test = OrderedDict(zip(b_names,b_test.mean(0)))
    b_std_test = OrderedDict(zip(b_names,b_test.std(0)))
    ...
    b_mean_test = bToDataFrame(b_mean_test)
    b_std_test = bToDataFrame(b_std_test)
    ...
    f = open(args.result_path + "/" + "summary_params_mean_std.txt", "w")
