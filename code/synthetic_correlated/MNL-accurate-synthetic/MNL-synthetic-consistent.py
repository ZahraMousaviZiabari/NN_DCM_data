...
X_train['INC_FULL'] = X_train['INC'] * X_train['FULL']
X_train['INC_FLEX'] = X_train['INC'] * X_train['FLEX']
X_train['FULL_FLEX'] = X_train['FULL'] * X_train['FLEX']
...
X_to_be_estimated = ["INC", "FULL", 'FLEX', 'INC_FULL', 'INC_FLEX', 'FULL_FLEX']
...
X_test['INC_FULL'] = X_test['INC'] * X_test['FULL']
X_test['INC_FLEX'] = X_test['INC'] * X_test['FLEX']
X_test['FULL_FLEX'] = X_test['FULL'] * X_test['FLEX']
